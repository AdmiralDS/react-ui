...
DraggableColumnsExample.parameters = {
  docs: {
    ...
    description: {
      ...
      Если перемещаемая миниатюра выходит за границы области заголовков таблицы наполовину, то перемещение становится невозможным, 
      ...
      Поэтому для таблицы должен быть задан колбек onColumnDrag, который срабатывает при каждой попытке изменить местоположения столбца таблицы.
