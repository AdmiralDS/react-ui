...
`]);return _templateObject8=function _templateObject(){return data},data}var getIcon=function(status){switch(status){case"info":return _admiral_ds_icons_build_service_InfoSolid_svg__WEBPACK_IMPORTED_MODULE_3__.h;case"error":return _admiral_ds_icons_build_service_CloseSolid_svg__WEBPACK_IMPORTED_MODULE_6__.h;case"success":return _admiral_ds_icons_build_service_CheckSolid_svg__WEBPACK_IMPORTED_MODULE_5__.h;default:return _admiral_ds_icons_build_service_ErrorSolid_svg__WEBPACK_IMPORTED_MODULE_4__.h}},backGroundColorMixin=(0,styled_components__WEBPACK_IMPORTED_MODULE_2__.AH)(_templateObject(),function(param){var theme=param.theme;switch(param.$status){case"warning":return"var(--admiral-color-Warning_Warning10, ".concat(theme.color["Warning/Warning 10"],")");case"error":return"var(--admiral-color-Error_Error10, ".concat(theme.color["Error/Error 10"],")");case"success":return"var(--admiral-color-Success_Success10, ".concat(theme.color["Success/Success 10"],")");default:return"var(--admiral-color-Primary_Primary10, ".concat(theme.color["Primary/Primary 10"],")")}}),borderColorMixin=(0,styled_components__WEBPACK_IMPORTED_MODULE_2__.AH)(_templateObject1(),function(param){var theme=param.theme,$status=param.$status;if(param.$hideBorder)return"transparent";switch($status){case"warning":return"var(--admiral-color-Warning_Warning50Main, ".concat(theme.color["Warning/Warning 50 Main"],")");case"error":return"var(--admiral-color-Error_Error60Main, ".concat(theme.color["Error/Error 60 Main"],")");case"success":return"var(--admiral-color-Success_Success50Main, ".concat(theme.color["Success/Success 50 Main"],")");default:return"var(--admiral-color-Primary_Primary60Main, ".concat(theme.color["Primary/Primary 60 Main"],")")}}),NotificationItemWrapper=styled_components__WEBPACK_IMPORTED_MODULE_2__.Ay.div(_templateObject2(),function(p){return(0,_src_components_themes_borderRadius__WEBPACK_IMPORTED_MODULE_9__.VM)(p.theme.shape)},function(p){return p.$displayStatusIcon?"":"padding-left: 15px;"},function(p){return p.$isClosable?"":"padding-right: 15px;"},borderColorMixin,backGroundColorMixin),Title=styled_components__WEBPACK_IMPORTED_MODULE_2__.Ay.div(_templateObject3(),_src_components_Typography__WEBPACK_IMPORTED_MODULE_8__.Il["Subtitle/Subtitle 3"],function(p){return p.theme.color["Neutral/Neutral 90"]}),CustomBody=styled_components__WEBPACK_IMPORTED_MODULE_2__.Ay.div(_templateObject4(),_src_components_Typography__WEBPACK_IMPORTED_MODULE_8__.Il["Body/Body 2 Long"],function(p){return p.theme.color["Neutral/Neutral 90"]}),ButtonPanel=styled_components__WEBPACK_IMPORTED_MODULE_2__.Ay.div(_templateObject5()),CloseButton=(0,styled_components__WEBPACK_IMPORTED_MODULE_2__.Ay)(_src_components_IconPlacement__WEBPACK_IMPORTED_MODULE_10__.H)(_templateObject6()),IconWrapper=styled_components__WEBPACK_IMPORTED_MODULE_2__.Ay.div(_templateObject7(),function(param){var theme=param.theme;switch(param.$status){case"warning":return"var(--admiral-color-Warning_Warning50Main, ".concat(theme.color["Warning/Warning 50 Main"],")");case"error":return"var(--admiral-color-Error_Error60Main, ".concat(theme.color["Error/Error 60 Main"],")");case"success":return"var(--admiral-color-Success_Success50Main, ".concat(theme.color["Success/Success 50 Main"],")");default:return"var(--admiral-color-Primary_Primary60Main, ".concat(theme.color["Primary/Primary 60 Main"],")")}}),nothing=function(){};NotificationItemWrapper.defaultProps={theme:_src_components_themes__WEBPACK_IMPORTED_MODULE_7__.d};var NotificationItem=(0,react__WEBPACK_IMPORTED_MODULE_1__.forwardRef)(function(_param,ref){var _param_status=_param.status,status=void 0===_param_status?"info":_param_status,_param_isBorderHidden=_param.isBorderHidden,_param_displayStatusIcon=_param.displayStatusIcon,displayStatusIcon=void 0!==_param_displayStatusIcon&&_param_displayStatusIcon,_param_isClosable=_param.isClosable,isClosable=void 0!==_param_isClosable&&_param_isClosable,onClose=_param.onClose,_param_closeButtonPropsConfig=_param.closeButtonPropsConfig,children=_param.children,props=_object_without_properties(_param,["status","isBorderHidden","displayStatusIcon","isClosable","onClose","closeButtonPropsConfig","children"]),NotificationIcon=getIcon(status),isAlert="info"!==status,closeButtonProps={dimension:"mSmall",highlightFocus:!1,onClick:onClose};return(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(NotificationItemWrapper,_object_spread_props(_object_spread({},props),{ref:ref,role:isAlert?"alert":"status","aria-live":isAlert?"assertive":"polite",$status:status,$hideBorder:void 0!==_param_isBorderHidden&&_param_isBorderHidden,$displayStatusIcon:displayStatusIcon,$isClosable:isClosable,children:[displayStatusIcon&&(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(IconWrapper,{$status:status,children:(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(NotificationIcon,{})}),children,isClosable&&(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(CloseButton,_object_spread({},closeButtonProps,(void 0===_param_closeButtonPropsConfig?nothing:_param_closeButtonPropsConfig)(closeButtonProps)))]}))}),NotificationItemTitle=function(_param){var children=_param.children,props=_object_without_properties(_param,["children"]);return(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Title,_object_spread_props(_object_spread({},props),{children:children}))},NotificationItemContent=function(_param){var children=_param.children,props=_object_without_properties(_param,["children"]);return(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(CustomBody,_object_spread_props(_object_spread({},props),{children:children}))},NotificationItemButtonPanel=function(_param){var children=_param.children,props=_object_without_properties(_param,["children"]);return(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ButtonPanel,_object_spread_props(_object_spread({},props),{children:children}))};NotificationItem.displayName="NotificationItem";var StyledNotificationItem=(0,styled_components__WEBPACK_IMPORTED_MODULE_2__.Ay)(NotificationItem)(_templateObject8(),function(p){return(0,_src_components_common_utils_parseShadowFromTheme__WEBPACK_IMPORTED_MODULE_11__.C)(p.theme.shadow["Shadow 08"])});try{NotificationItem.displayName="NotificationItem",NotificationItem.__docgenInfo={description:"",displayName:"NotificationItem",props:{status:{defaultValue:{value:"info"},description:"Статус notification",name:"status",required:!1,type:{name:"enum",value:[{value:'"error"'},{value:'"success"'},{value:'"warning"'},{value:'"info"'}]}},isBorderHidden:{defaultValue:{value:"false"},description:"Скрыть обводку notification",name:"isBorderHidden",required:!1,type:{name:"boolean"}},isClosable:{defaultValue:{value:"false"},description:'Переключатель видимости иконки "Close"',name:"isClosable",required:!1,type:{name:"boolean"}},onClose:{defaultValue:null,description:"Закрытие notification",name:"onClose",required:!1,type:{name:"(() => void)"}},displayStatusIcon:{defaultValue:{value:"false"},description:"Переключатель видимости статусных иконок",name:"displayStatusIcon",required:!1,type:{name:"boolean"}},closeButtonPropsConfig:{defaultValue:{value:"() => {}"},description:`Конфиг функция пропсов для кнопки закрытия уведомления. На вход получает начальный набор пропсов, на
выход должна отдавать объект с пропсами, которые будут внедряться после оригинальных пропсов.`,name:"closeButtonPropsConfig",required:!1,type:{name:'((props: FastOmit<Omit<IconPlacementProps & RefAttributes<HTMLButtonElement>, "ref"> & { ref?: ((instance: HTMLButtonElement | null) => void) | RefObject<...> | null; }, never>) => Partial<...>)'}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/NotificationItem/index.tsx#NotificationItem"]={docgenInfo:NotificationItem.__docgenInfo,name:"NotificationItem",path:"src/components/NotificationItem/index.tsx#NotificationItem"})}catch(__react_docgen_typescript_loader_error){}try{NotificationItemTitle.displayName="NotificationItemTitle",NotificationItemTitle.__docgenInfo={description:"",displayName:"NotificationItemTitle",props:{}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/NotificationItem/index.tsx#NotificationItemTitle"]={docgenInfo:NotificationItemTitle.__docgenInfo,name:"NotificationItemTitle",path:"src/components/NotificationItem/index.tsx#NotificationItemTitle"})}catch(__react_docgen_typescript_loader_error){}try{NotificationItemContent.displayName="NotificationItemContent",NotificationItemContent.__docgenInfo={description:"",displayName:"NotificationItemContent",props:{}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/NotificationItem/index.tsx#NotificationItemContent"]={docgenInfo:NotificationItemContent.__docgenInfo,name:"NotificationItemContent",path:"src/components/NotificationItem/index.tsx#NotificationItemContent"})}catch(__react_docgen_typescript_loader_error){}try{StyledNotificationItem.displayName="StyledNotificationItem",StyledNotificationItem.__docgenInfo={description:"",displayName:"StyledNotificationItem",props:{theme:{defaultValue:{value:`{
  color,
  shadow,
  zIndex,
  name: 'light',
...
}`},description:"",name:"theme",required:!1,type:{name:"DefaultTheme"}},as:{defaultValue:null,description:"",name:"as",required:!1,type:{name:"void | WebTarget"}},forwardedAs:{defaultValue:null,description:"",name:"forwardedAs",required:!1,type:{name:"void | WebTarget"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/NotificationItem/index.tsx#StyledNotificationItem"]={docgenInfo:StyledNotificationItem.__docgenInfo,name:"StyledNotificationItem",path:"src/components/NotificationItem/index.tsx#StyledNotificationItem"})}catch(__react_docgen_typescript_loader_error){}}}]);