...
`]);return _templateObject2=function _templateObject(){return data},data}function _templateObject3(){var data=_tagged_template_literal([`
  ...
  `,`
`]);return _templateObject3=function _templateObject(){return data},data}var Text=styled_components_browser_esm.Ay.span(_templateObject()),Circle=styled_components_browser_esm.Ay.div(_templateObject1()),cssDefault=(0,styled_components_browser_esm.AH)(_templateObject2(),Text,function(p){return p.theme.color["Neutral/Neutral 90"]},Circle,function(p){return p.theme.color["Neutral/Neutral 50"]}),StatusContainer=styled_components_browser_esm.Ay.div(_templateObject3(),function(p){return p.$displayRight?"row":"row-reverse"},function(p){return"m"===p.$dimension?"24px":"20px"},function(p){return"m"===p.$dimension?typography.Il["Body/Body 1 Long"]:typography.Il["Body/Body 2 Long"]},Circle,function(p){return"m"===p.$dimension?"20px":"16px"},function(p){return"m"===p.$dimension?"20px":"16px"},function(p){return p.$displayRight?"0 10px 0 0":"0 0 0 10px"},function(p){return p.$cssMixin||cssDefault}),StatusIndicator=function(param){var _param_dimension=param.dimension,_param_displayRight=param.displayRight,icon=param.icon,cssMixin=param.cssMixin,text=param.text;return(0,jsx_runtime.jsxs)(StatusContainer,{$dimension:void 0===_param_dimension?"m":_param_dimension,$displayRight:void 0===_param_displayRight||_param_displayRight,$cssMixin:cssMixin,children:[icon&&(0,jsx_runtime.jsx)(Circle,{children:icon}),(0,jsx_runtime.jsx)(Text,{children:text})]})};StatusIndicator.displayName="StatusIndicator";try{StatusIndicator.displayName="StatusIndicator",StatusIndicator.__docgenInfo={description:"",displayName:"StatusIndicator",props:{dimension:{defaultValue:{value:"m"},description:"Размер компонента",name:"dimension",required:!1,type:{name:"enum",value:[{value:'"s"'},{value:'"m"'}]}},cssMixin:{defaultValue:null,description:"Позволяет добавлять миксин, созданный с помощью styled css",name:"cssMixin",required:!1,type:{name:"RuleSet<object>"}},icon:{defaultValue:null,description:"Иконка индикатора статуса",name:"icon",required:!1,type:{name:"ReactNode"}},displayRight:{defaultValue:{value:"true"},description:"Позиционирование иконки статуса. По умолчанию - слева",name:"displayRight",required:!1,type:{name:"boolean"}},text:{defaultValue:null,description:"Текст статуса",name:"text",required:!0,type:{name:"string"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/StatusIndicator/index.tsx#StatusIndicator"]={docgenInfo:StatusIndicator.__docgenInfo,name:"StatusIndicator",path:"src/components/StatusIndicator/index.tsx#StatusIndicator"})}catch(__react_docgen_typescript_loader_error){}var CheckOutline=__webpack_require__("./node_modules/@admiral-ds/icons/build/service/CheckOutline.svg");function _define_property(obj,key,value){return key in obj?Object.defineProperty(obj,key,{value:value,enumerable:!0,configurable:!0,writable:!0}):obj[key]=value,obj}function _object_spread(target){for(var i=1;i<arguments.length;i++){var source=null!=arguments[i]?arguments[i]:{},ownKeys=Object.keys(source);"function"==typeof Object.getOwnPropertySymbols&&(ownKeys=ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function(sym){return Object.getOwnPropertyDescriptor(source,sym).enumerable}))),ownKeys.forEach(function(key){_define_property(target,key,source[key])})}return target}function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);enumerableOnly&&(symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable})),keys.push.apply(keys,symbols)}return keys}function _object_spread_props(target,source){return source=null!=source?source:{},Object.getOwnPropertyDescriptors?Object.defineProperties(target,Object.getOwnPropertyDescriptors(source)):ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key))}),target}function _object_without_properties(source,excluded){if(null==source)return{};var key,i,target=_object_without_properties_loose(source,excluded);if(Object.getOwnPropertySymbols){var sourceSymbolKeys=Object.getOwnPropertySymbols(source);for(i=0;i<sourceSymbolKeys.length;i++)key=sourceSymbolKeys[i],!(excluded.indexOf(key)>=0)&&Object.prototype.propertyIsEnumerable.call(source,key)&&(target[key]=source[key])}return target}function _object_without_properties_loose(source,excluded){if(null==source)return{};var key,i,target={},sourceKeys=Object.keys(source);for(i=0;i<sourceKeys.length;i++)key=sourceKeys[i],excluded.indexOf(key)>=0||(target[key]=source[key]);return target}var StatusIndicatorPlaygroundTemplate=function(_param){var _param_text=_param.text,props=_object_without_properties(_param,["text"]);return(0,jsx_runtime.jsx)(StatusIndicator,_object_spread_props(_object_spread({},props),{text:void 0===_param_text?"P 16px/24 book":_param_text,icon:(0,jsx_runtime.jsx)(CheckOutline.h,{})}))};try{StatusIndicatorPlaygroundTemplate.displayName="StatusIndicatorPlaygroundTemplate",StatusIndicatorPlaygroundTemplate.__docgenInfo={description:"",displayName:"StatusIndicatorPlaygroundTemplate",props:{dimension:{defaultValue:null,description:"Размер компонента",name:"dimension",required:!1,type:{name:"enum",value:[{value:'"s"'},{value:'"m"'}]}},cssMixin:{defaultValue:null,description:"Позволяет добавлять миксин, созданный с помощью styled css",name:"cssMixin",required:!1,type:{name:"RuleSet<object>"}},icon:{defaultValue:null,description:"Иконка индикатора статуса",name:"icon",required:!1,type:{name:"ReactNode"}},displayRight:{defaultValue:null,description:"Позиционирование иконки статуса. По умолчанию - слева",name:"displayRight",required:!1,type:{name:"boolean"}},text:{defaultValue:{value:"P 16px/24 book"},description:"Текст статуса",name:"text",required:!1,type:{name:"string"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/StatusIndicator/stories/StatusIndicatorPlayground.template.tsx#StatusIndicatorPlaygroundTemplate"]={docgenInfo:StatusIndicatorPlaygroundTemplate.__docgenInfo,name:"StatusIndicatorPlaygroundTemplate",path:"src/components/StatusIndicator/stories/StatusIndicatorPlayground.template.tsx#StatusIndicatorPlaygroundTemplate"})}catch(__react_docgen_typescript_loader_error){}var T=__webpack_require__("./src/components/T/index.tsx"),InfoSolid=__webpack_require__("./node_modules/@admiral-ds/icons/build/service/InfoSolid.svg");function StatusIndicatorDimension_template_tagged_template_literal(strings,raw){return raw||(raw=strings.slice(0)),Object.freeze(Object.defineProperties(strings,{raw:{value:Object.freeze(raw)}}))}function StatusIndicatorDimension_template_templateObject(){var data=StatusIndicatorDimension_template_tagged_template_literal([`
  margin: 24px 0 10px 0;
`]);return StatusIndicatorDimension_template_templateObject=function _templateObject(){return data},data}var StyledText=(0,styled_components_browser_esm.Ay)(T.T)(StatusIndicatorDimension_template_templateObject()),StatusIndicatorDimensionTemplate=function(){return(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[(0,jsx_runtime.jsx)(T.T,{font:"Body/Body 1 Long",as:"div",children:"Компонент регулируется только по высоте и представлен в размерах M (24px) и S (20px), ширина подстраивается под контент."}),(0,jsx_runtime.jsx)(StyledText,{font:"Body/Body 2 Long",forwardedAs:"div",children:"Dimension - M"}),(0,jsx_runtime.jsx)(StatusIndicator,{dimension:"m",text:"P 16px/24 book",icon:(0,jsx_runtime.jsx)(CheckOutline.h,{})}),(0,jsx_runtime.jsx)(StyledText,{font:"Body/Body 2 Long",forwardedAs:"div",children:"Dimension - S"}),(0,jsx_runtime.jsx)(StatusIndicator,{dimension:"s",text:"P 14px/20 book",icon:(0,jsx_runtime.jsx)(InfoSolid.h,{})})]})},ErrorSolid=__webpack_require__("./node_modules/@admiral-ds/icons/build/service/ErrorSolid.svg");function StatusIndicatorPosition_template_tagged_template_literal(strings,raw){return raw||(raw=strings.slice(0)),Object.freeze(Object.defineProperties(strings,{raw:{value:Object.freeze(raw)}}))}function StatusIndicatorPosition_template_templateObject(){var data=StatusIndicatorPosition_template_tagged_template_literal([`
  margin: 24px 0 10px 0;
`]);return StatusIndicatorPosition_template_templateObject=function _templateObject(){return data},data}function StatusIndicatorPosition_template_templateObject1(){var data=StatusIndicatorPosition_template_tagged_template_literal([`
...
`]);return StatusIndicatorPosition_template_templateObject1=function _templateObject(){return data},data}var StatusIndicatorPosition_template_StyledText=(0,styled_components_browser_esm.Ay)(T.T)(StatusIndicatorPosition_template_templateObject()),OrangeColor=(0,styled_components_browser_esm.AH)(StatusIndicatorPosition_template_templateObject1(),function(p){return p.theme.color["Warning/Warning 50 Main"]},function(p){return p.theme.color["Warning/Warning 50 Main"]}),StatusIndicatorPositionTemplate=function(){return(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[(0,jsx_runtime.jsx)(T.T,{font:"Body/Body 1 Long",as:"div",children:"Через параметр cssMixin можно изменять цветовое отображение статуса. Также с помощью параметра displayRight можно управлять позиционированием иконки."}),(0,jsx_runtime.jsx)(StatusIndicatorPosition_template_StyledText,{font:"Body/Body 2 Long",forwardedAs:"div",children:"Кастомное цветовое отображение статуса"}),(0,jsx_runtime.jsx)(StatusIndicator,{cssMixin:OrangeColor,dimension:"m",text:"P 16px/24 book",icon:(0,jsx_runtime.jsx)(InfoSolid.h,{})}),(0,jsx_runtime.jsx)(StatusIndicatorPosition_template_StyledText,{font:"Body/Body 2 Long",forwardedAs:"div",children:"Позиционирование иконки индикатора справа"}),(0,jsx_runtime.jsx)(StatusIndicator,{dimension:"m",text:"P 16px/24 book",displayRight:!1,icon:(0,jsx_runtime.jsx)(ErrorSolid.h,{})}),(0,jsx_runtime.jsx)(StatusIndicatorPosition_template_StyledText,{font:"Body/Body 2 Long",forwardedAs:"div",children:"Без иконки"}),(0,jsx_runtime.jsx)(StatusIndicator,{dimension:"m",text:"P 16px/24 book"})]})};let StatusIndicatorPlayground_templateraw_namespaceObject=`import * as React from 'react';
...
`,StatusIndicatorDimension_templateraw_namespaceObject=`import * as React from 'react';
...
`,StatusIndicatorPosition_templateraw_namespaceObject=`import * as React from 'react';
...
`;function StatusIndicator_stories_define_property(obj,key,value){return key in obj?Object.defineProperty(obj,key,{value:value,enumerable:!0,configurable:!0,writable:!0}):obj[key]=value,obj}function StatusIndicator_stories_object_spread(target){for(var i=1;i<arguments.length;i++){var source=null!=arguments[i]?arguments[i]:{},ownKeys=Object.keys(source);"function"==typeof Object.getOwnPropertySymbols&&(ownKeys=ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function(sym){return Object.getOwnPropertyDescriptor(source,sym).enumerable}))),ownKeys.forEach(function(key){StatusIndicator_stories_define_property(target,key,source[key])})}return target}function StatusIndicator_stories_tagged_template_literal(strings,raw){return raw||(raw=strings.slice(0)),Object.freeze(Object.defineProperties(strings,{raw:{value:Object.freeze(raw)}}))}function StatusIndicator_stories_templateObject(){var data=StatusIndicator_stories_tagged_template_literal([`
  font-family: 'VTB Group UI', serif;
  font-size: 16px;
  line-height: 24px;
`]);return StatusIndicator_stories_templateObject=function _templateObject(){return data},data}var Desc=styled_components_browser_esm.Ay.div(StatusIndicator_stories_templateObject());let StatusIndicator_stories={title:"Admiral-2.1/StatusIndicator",decorators:void 0,component:StatusIndicator,parameters:{docs:{source:{code:null}},componentSubtitle:(0,jsx_runtime.jsx)(function(){return(0,jsx_runtime.jsx)(Desc,{children:"Компонент Status Indicator используется для отображения состояния объекта или действия."})},{}),layout:"centered",design:{type:"figma",url:"https://www.figma.com/file/CC0WL5u9TPtZpyLbbAGFGt/Admiral-2.0-UI-Kit?node-id=37%3A18744"}},argTypes:{dimension:{options:["m","s"],control:{type:"radio"}},text:{control:{type:"text"}},displayRight:{control:{type:"boolean"}},cssMixin:{control:!1},icon:{control:!1}}};var StatusIndicatorPlayground={render:function(props){return(0,jsx_runtime.jsx)(StatusIndicatorPlaygroundTemplate,StatusIndicator_stories_object_spread({},props))},parameters:{docs:{source:{code:StatusIndicatorPlayground_templateraw_namespaceObject}}}},StatusIndicatorDimension={render:function(){return(0,jsx_runtime.jsx)(StatusIndicatorDimensionTemplate,{})},name:"Status Indicator. Размеры компонента",parameters:{docs:{source:{code:StatusIndicatorDimension_templateraw_namespaceObject}}}},StatusIndicatorPosition={render:function(){return(0,jsx_runtime.jsx)(StatusIndicatorPositionTemplate,{})},name:"Status Indicator. Альтернативные варианты отображения",parameters:{docs:{source:{code:StatusIndicatorPosition_templateraw_namespaceObject}}}};StatusIndicatorPlayground.parameters={...StatusIndicatorPlayground.parameters,docs:{...StatusIndicatorPlayground.parameters?.docs,source:{originalSource:`{
...
//# sourceMappingURL=components-StatusIndicator-stories-StatusIndicator-stories.d3819f90.iframe.bundle.js.map