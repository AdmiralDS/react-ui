...
`]);return DateTimeFieldDisabled_template_templateObject=function _templateObject(){return data},data}var DateTimeFieldDisabled_template_DisplayContainer=styled_components_browser_esm.Ay.div(DateTimeFieldDisabled_template_templateObject()),DateTimeFieldDisabledTemplate=function(_param){var _param_label=_param.label,dimension=_param.dimension,status=_param.status,_param_disabled=_param.disabled,disabled=void 0===_param_disabled||_param_disabled,readOnly=_param.readOnly,skeleton=_param.skeleton,themeBorderKind=_param.themeBorderKind,CSSCustomProps=_param.CSSCustomProps,fieldProps=DateTimeFieldDisabled_template_object_spread({label:void 0===_param_label?"Disabled control":_param_label,status:status,disabled:disabled,readOnly:readOnly,skeleton:skeleton},DateTimeFieldDisabled_template_object_without_properties(_param,["label","dimension","status","disabled","readOnly","skeleton","themeBorderKind","CSSCustomProps"])),baseDateTimeProps={status:status,disabled:disabled,readOnly:readOnly},dateTimeProps=DateTimeFieldDisabled_template_object_spread({dimension:dimension,skeleton:skeleton},baseDateTimeProps);return(0,jsx_runtime.jsx)(styled_components_browser_esm.NP,{theme:(0,createBorderRadiusSwapper.j)(themeBorderKind,CSSCustomProps),children:(0,jsx_runtime.jsx)(DateTimeFieldDisabled_template_DisplayContainer,{children:(0,jsx_runtime.jsx)(Field.D0,DateTimeFieldDisabled_template_object_spread_props(DateTimeFieldDisabled_template_object_spread({},fieldProps),{children:(0,jsx_runtime.jsxs)(DateTimeContainer,DateTimeFieldDisabled_template_object_spread_props(DateTimeFieldDisabled_template_object_spread({},baseDateTimeProps),{disabled:disabled||skeleton,children:[(0,jsx_runtime.jsx)(DateTimeDateInput,DateTimeFieldDisabled_template_object_spread({},dateTimeProps)),(0,jsx_runtime.jsx)(DateTimeSeparator,DateTimeFieldDisabled_template_object_spread_props(DateTimeFieldDisabled_template_object_spread({},baseDateTimeProps),{disabled:disabled||skeleton})),(0,jsx_runtime.jsx)(DateTimeTimeInput,DateTimeFieldDisabled_template_object_spread({},dateTimeProps))]}))}))})})};try{DateTimeFieldDisabledTemplate.displayName="DateTimeFieldDisabledTemplate",DateTimeFieldDisabledTemplate.__docgenInfo={description:"",displayName:"DateTimeFieldDisabledTemplate",props:{dimension:{defaultValue:null,description:"",name:"dimension",required:!1,type:{name:"enum",value:[{value:'"s"'},{value:'"xl"'},{value:'"m"'}]}},extraText:{defaultValue:null,description:"Текст будет виден ниже компонента",name:"extraText",required:!1,type:{name:"ReactNode"}},status:{defaultValue:null,description:"Установка статуса поля",name:"status",required:!1,type:{name:"enum",value:[{value:'"error"'},{value:'"success"'}]}},required:{defaultValue:null,description:"Установка статуса поле обязательно для заполнения",name:"required",required:!1,type:{name:"boolean"}},disabled:{defaultValue:{value:"true"},description:"Установка статуса disabled",name:"disabled",required:!1,type:{name:"boolean"}},readOnly:{defaultValue:null,description:"",name:"readOnly",required:!1,type:{name:"boolean"}},label:{defaultValue:{value:"Disabled control"},description:"Имя поля формы",name:"label",required:!1,type:{name:"ReactNode"}},displayInline:{defaultValue:null,description:"Отображать лейбл в одну строчку с инпутом",name:"displayInline",required:!1,type:{name:"boolean"}},maxLength:{defaultValue:null,description:"Максимальное количество символов для ввода",name:"maxLength",required:!1,type:{name:"number"}},inputRef:{defaultValue:null,description:"",name:"inputRef",required:!1,type:{name:"RefObject<HTMLInputElement | HTMLTextAreaElement>"}},displayCharacterCounter:{defaultValue:null,description:"Позволяет отключать появление счетчика символов при задании maxLength",name:"displayCharacterCounter",required:!1,type:{name:"boolean"}},characterCounterVisibilityThreshold:{defaultValue:null,description:`Коэффициент влияющий на появление счетчика при заданном максимальном количестве символов:
0 - всегда видим
1 - всегда невидим
...
`]);return DateTimeFieldStatus_template_templateObject=function _templateObject(){return data},data}var DateTimeFieldStatus_template_DisplayContainer=styled_components_browser_esm.Ay.div(DateTimeFieldStatus_template_templateObject()),DateTimeFieldStatusTemplate=function(_param){var _param_label=_param.label,dimension=_param.dimension,disabled=_param.disabled,readOnly=_param.readOnly,skeleton=_param.skeleton,_param_status=_param.status,status=void 0===_param_status?"success":_param_status,extraText=_param.extraText,themeBorderKind=_param.themeBorderKind,CSSCustomProps=_param.CSSCustomProps,fieldProps=DateTimeFieldStatus_template_object_spread({label:void 0===_param_label?"Status control":_param_label,disabled:disabled,readOnly:readOnly,skeleton:skeleton},DateTimeFieldStatus_template_object_without_properties(_param,["label","dimension","disabled","readOnly","skeleton","status","extraText","themeBorderKind","CSSCustomProps"])),baseDateTimeProps={disabled:disabled,readOnly:readOnly},dateTimeProps=DateTimeFieldStatus_template_object_spread({dimension:dimension,skeleton:skeleton},baseDateTimeProps),_React_useState=_sliced_to_array(react.useState(status),2),dateTimeStatus=_React_useState[0],setDateTimeStatus=_React_useState[1],_React_useState1=_sliced_to_array(react.useState(""),2),additionalText=_React_useState1[0],setAdditionalText=_React_useState1[1];return react.useEffect(function(){return disabled||readOnly?void setAdditionalText(""):extraText?void setAdditionalText(String(extraText)):void setAdditionalText("Additional text")},[disabled,readOnly,extraText]),react.useEffect(function(){if(!disabled&&!readOnly){switch(status){case"success":setDateTimeStatus("success");break;case"error":setDateTimeStatus("error")}if(extraText)return void setAdditionalText(String(extraText));setAdditionalText("Additional text")}},[status]),(0,jsx_runtime.jsx)(styled_components_browser_esm.NP,{theme:(0,createBorderRadiusSwapper.j)(themeBorderKind,CSSCustomProps),children:(0,jsx_runtime.jsx)(DateTimeFieldStatus_template_DisplayContainer,{children:(0,jsx_runtime.jsx)(Field.D0,DateTimeFieldStatus_template_object_spread_props(DateTimeFieldStatus_template_object_spread({},fieldProps),{status:dateTimeStatus,extraText:additionalText,children:(0,jsx_runtime.jsxs)(DateTimeContainer,DateTimeFieldStatus_template_object_spread_props(DateTimeFieldStatus_template_object_spread({},baseDateTimeProps),{status:dateTimeStatus,disabled:disabled||skeleton,children:[(0,jsx_runtime.jsx)(DateTimeDateInput,DateTimeFieldStatus_template_object_spread_props(DateTimeFieldStatus_template_object_spread({},dateTimeProps),{defaultValue:"12.10.2022",status:dateTimeStatus})),(0,jsx_runtime.jsx)(DateTimeSeparator,DateTimeFieldStatus_template_object_spread_props(DateTimeFieldStatus_template_object_spread({},baseDateTimeProps),{status:dateTimeStatus,disabled:disabled||skeleton})),(0,jsx_runtime.jsx)(DateTimeTimeInput,DateTimeFieldStatus_template_object_spread_props(DateTimeFieldStatus_template_object_spread({},dateTimeProps),{defaultValue:"12:10",status:dateTimeStatus}))]}))}))})})};try{DateTimeFieldStatusTemplate.displayName="DateTimeFieldStatusTemplate",DateTimeFieldStatusTemplate.__docgenInfo={description:"",displayName:"DateTimeFieldStatusTemplate",props:{dimension:{defaultValue:null,description:"",name:"dimension",required:!1,type:{name:"enum",value:[{value:'"s"'},{value:'"xl"'},{value:'"m"'}]}},extraText:{defaultValue:null,description:"Текст будет виден ниже компонента",name:"extraText",required:!1,type:{name:"ReactNode"}},status:{defaultValue:{value:"success"},description:"Установка статуса поля",name:"status",required:!1,type:{name:"enum",value:[{value:'"error"'},{value:'"success"'}]}},required:{defaultValue:null,description:"Установка статуса поле обязательно для заполнения",name:"required",required:!1,type:{name:"boolean"}},disabled:{defaultValue:null,description:"Установка статуса disabled",name:"disabled",required:!1,type:{name:"boolean"}},readOnly:{defaultValue:null,description:"",name:"readOnly",required:!1,type:{name:"boolean"}},label:{defaultValue:{value:"Status control"},description:"Имя поля формы",name:"label",required:!1,type:{name:"ReactNode"}},displayInline:{defaultValue:null,description:"Отображать лейбл в одну строчку с инпутом",name:"displayInline",required:!1,type:{name:"boolean"}},maxLength:{defaultValue:null,description:"Максимальное количество символов для ввода",name:"maxLength",required:!1,type:{name:"number"}},inputRef:{defaultValue:null,description:"",name:"inputRef",required:!1,type:{name:"RefObject<HTMLInputElement | HTMLTextAreaElement>"}},displayCharacterCounter:{defaultValue:null,description:"Позволяет отключать появление счетчика символов при задании maxLength",name:"displayCharacterCounter",required:!1,type:{name:"boolean"}},characterCounterVisibilityThreshold:{defaultValue:null,description:`Коэффициент влияющий на появление счетчика при заданном максимальном количестве символов:
0 - всегда видим
1 - всегда невидим
...
//# sourceMappingURL=components-form-DateTimeField-stories-DateTimeField-stories.00a23d3b.iframe.bundle.js.map