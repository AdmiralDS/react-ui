try{
var Xo=Object.defineProperty;var w=(o,e)=>()=>(o&&(e=o(o=0)),e);var Yt=(o,e)=>{for(var t in e)Xo(o,t,{get:e[t],enumerable:!0})};var d=w(()=>{});var g,p=w(()=>{g={NODE_ENV:"production",NODE_PATH:[],STORYBOOK:"true",PUBLIC_URL:"."}});var h=w(()=>{});var Xi,qi,Ki,Zt,Ji,Qi,es,ts,rs,os,ns,is,ss,as,Gt,ls,cs,us,ds,ps,hs,fs,ms,Te,gs,ke,vs,ys,re,bs,xs,_s,ws,I,$s,Es,Ss,Xt,As,Ps,Cs,Ms,Ts,ks,Os,Ns,Rs,Bs,js,qt,Ls,Is,Fs,Hs,Us,zs,Ds,Vs,Ys,Ws,Zs,Gs,Xs,qs,Ks,Js,Qs,U=w(()=>{d();p();h();Xi=__STORYBOOKCOMPONENTS__,{A:qi,ActionBar:Ki,AddonPanel:Zt,Badge:Ji,Bar:Qi,Blockquote:es,Button:ts,ClipboardCode:rs,Code:os,DL:ns,Div:is,DocumentWrapper:ss,ErrorFormatter:as,FlexBar:Gt,Form:ls,H1:cs,H2:us,H3:ds,H4:ps,H5:hs,H6:fs,HR:ms,IconButton:Te,IconButtonSkeleton:gs,Icons:ke,Img:vs,LI:ys,Link:re,ListItem:bs,Loader:xs,OL:_s,P:ws,Placeholder:I,Pre:$s,ResetWrapper:Es,ScrollArea:Ss,Separator:Xt,Spaced:As,Span:Ps,StorybookIcon:Cs,StorybookLogo:Ms,Symbols:Ts,SyntaxHighlighter:ks,TT:Os,TabBar:Ns,TabButton:Rs,TabWrapper:Bs,Table:js,Tabs:qt,TabsState:Ls,TooltipLinkList:Is,TooltipMessage:Fs,TooltipNote:Hs,UL:Us,WithTooltip:zs,WithTooltipPure:Ds,Zoom:Vs,codeCommon:Ys,components:Ws,createCopyToClipboardFunction:Zs,getStoryHref:Gs,icons:Xs,interleaveSeparators:qs,nameSpaceClassNames:Ks,resetComponents:Js,withReset:Qs}=__STORYBOOKCOMPONENTS__});var na,ia,sa,aa,la,ca,ua,da,pa,ha,fa,ma,O,ga,va,ya,ba,f,xa,_a,wa,$a,Ea,Sa,Aa,L=w(()=>{d();p();h();na=__STORYBOOKTHEMING__,{CacheProvider:ia,ClassNames:sa,Global:aa,ThemeProvider:la,background:ca,color:ua,convert:da,create:pa,createCache:ha,createGlobal:fa,createReset:ma,css:O,darken:ga,ensure:va,ignoreSsrWarning:ya,isPropValid:ba,jsx:f,keyframes:xa,lighten:_a,styled:wa,themes:$a,typography:Ea,useTheme:Sa,withTheme:Aa}=__STORYBOOKTHEMING__});var Ne={};Yt(Ne,{Children:()=>Jo,Component:()=>tt,Fragment:()=>S,Profiler:()=>Qo,PureComponent:()=>en,StrictMode:()=>tn,Suspense:()=>rt,__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:()=>rn,cloneElement:()=>on,createContext:()=>nn,createElement:()=>sn,createFactory:()=>an,createRef:()=>ln,default:()=>Ko,forwardRef:()=>cn,isValidElement:()=>un,lazy:()=>ot,memo:()=>dn,useCallback:()=>F,useContext:()=>pn,useDebugValue:()=>hn,useEffect:()=>N,useImperativeHandle:()=>fn,useLayoutEffect:()=>mn,useMemo:()=>W,useReducer:()=>gn,useRef:()=>vn,useState:()=>T,version:()=>yn});var Ko,Jo,tt,S,Qo,en,tn,rt,rn,on,nn,sn,an,ln,cn,un,ot,dn,F,pn,hn,N,fn,mn,W,gn,vn,T,yn,R=w(()=>{d();p();h();Ko=__REACT__,{Children:Jo,Component:tt,Fragment:S,Profiler:Qo,PureComponent:en,StrictMode:tn,Suspense:rt,__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:rn,cloneElement:on,createContext:nn,createElement:sn,createFactory:an,createRef:ln,forwardRef:cn,isValidElement:un,lazy:ot,memo:dn,useCallback:F,useContext:pn,useDebugValue:hn,useEffect:N,useImperativeHandle:fn,useLayoutEffect:mn,useMemo:W,useReducer:gn,useRef:vn,useState:T,version:yn}=__REACT__});var it,ce,xn,_n,wn,Kt,Jt,Qt,Re=w(()=>{d();p();h();R();L();U();it=function(o,e){return Object.defineProperty?Object.defineProperty(o,"raw",{value:e}):o.raw=e,o},ce=function(o){var e=o.config,t=o.defer,r=t===void 0?!1:t,n=T(r?void 0:e.url),i=n[0],s=n[1],c=T(!1),a=c[0],l=c[1];return N(function(){if(r){var u=requestAnimationFrame(function(){s(e.url)});return function(){return cancelAnimationFrame(u)}}},[r,e.url]),N(function(){l(!1)},[i]),f("div",{css:xn},!a&&f(I,{css:_n},"Loading..."),f("iframe",{css:wn,src:i,allowFullScreen:e.allowFullscreen,onLoad:function(){return l(!0)}}))},xn=O(Kt||(Kt=it([`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
`],[`
  ...
  z-index: 1;
`])))});var st,$n,er,at=w(()=>{d();p();h();R();L();Re();st=/https:\/\/([w.-]+.)?figma.com\/(file|proto)\/([0-9a-zA-Z]{22,128})(?:\/.*)?$/,$n=function(o){return st.test(o)},er=function(o){var e=o.config,t=W(function(){var r=$n(e.url);if(!r)return console.warn(`[storybook-addon-designs] The URL you specified is not valid Figma URL.
The addon fallbacks to normal iframe mode.For more detail, please check <https://www.figma.com/developers/embed>.`),e;var n=e.embedHost||location.hostname,i="https://www.figma.com/embed?embed_host=".concat(n,"&url=").concat(e.url);return{url:i,allowFullscreen:e.allowFullscreen}},[e.url,e.allowFullscreen,e.embedHost]);return f(ce,{defer:!0,config:t})}});var Be,je,ut,vr,ge,yr,B,dt,Le,pt=w(()=>{d();p();h();Be=window,je=Be.ShadowRoot&&(Be.ShadyCSS===void 0||Be.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ut=Symbol(),vr=new WeakMap,ge=class{constructor(e,t,r){if(this._$cssResult$=!0,r!==ut)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(je&&e===void 0){let r=t!==void 0&&t.length===1;r&&(e=vr.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),r&&vr.set(t,e))}return e}toString(){return this.cssText}},yr=o=>new ge(typeof o=="string"?o:o+"",void 0,ut),B=(o,...e)=>{let t=o.length===1?o[0]:e.reduce((r,n,i)=>r+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(n)+o[i+1],o[0]);return new ge(t,o,ut)},dt=(o,e)=>{je?o.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{let r=document.createElement("style"),n=Be.litNonce;n!==void 0&&r.setAttribute("nonce",n),r.textContent=t.cssText,o.appendChild(r)})},Le=je?o=>o:o=>o instanceof CSSStyleSheet?(e=>{let t="";for(let r of e.cssRules)t+=r.cssText;return yr(t)})(o):o});var ht,Ie,br,On,xr,mt,_r,ft,gt,Z,Fe=w(()=>{d();p();h();pt();pt();Ie=window,br=Ie.trustedTypes,On=br?br.emptyScript:"",xr=Ie.reactiveElementPolyfillSupport,mt={toAttribute(o,e){switch(e){case Boolean:o=o?On:null;break;case Object:case Array:o=o==null?o:JSON.stringify(o)}return o},fromAttribute(o,e){let t=o;switch(e){case Boolean:t=o!==null;break;case Number:t=o===null?null:Number(o);break;case Object:case Array:try{t=JSON.parse(o)}catch{t=null}}return t}},_r=(o,e)=>e!==o&&(e==e||o==o),ft={attribute:!0,type:String,converter:mt,reflect:!1,hasChanged:_r},gt="finalized",Z=class extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this._$Eu()}static addInitializer(e){var t;this.finalize(),((t=this.h)!==null&&t!==void 0?t:this.h=[]).push(e)}static get observedAttributes(){this.finalize();let e=[];return this.elementProperties.forEach((t,r)=>{let n=this._$Ep(r,t);n!==void 0&&(this._$Ev.set(n,r),e.push(n))}),e}static createProperty(e,t=ft){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){let r=typeof e=="symbol"?Symbol():"__"+e,n=this.getPropertyDescriptor(e,r,t);n!==void 0&&Object.defineProperty(this.prototype,e,n)}}static getPropertyDescriptor(e,t,r){return{get(){return this[t]},set(n){let i=this[e];this[t]=n,this.requestUpdate(e,i,r)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||ft}static finalize(){if(this.hasOwnProperty(gt))return!1;this[gt]=!0;let e=Object.getPrototypeOf(this);if(e.finalize(),e.h!==void 0&&(this.h=[...e.h]),this.elementProperties=new Map(e.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){let t=this.properties,r=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(let n of r)this.createProperty(n,t[n])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let r=new Set(e.flat(1/0).reverse());for(let n of r)t.unshift(Le(n))}else e!==void 0&&t.push(Le(e));return t}static _$Ep(e,t){let r=t.attribute;return r===!1?void 0:typeof r=="string"?r:typeof e=="string"?e.toLowerCase():void 0}_$Eu(){var e;this._$E_=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(e=this.constructor.h)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,r;((t=this._$ES)!==null&&t!==void 0?t:this._$ES=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((r=e.hostConnected)===null||r===void 0||r.call(e))}removeController(e){var t;(t=this._$ES)===null||t===void 0||t.splice(this._$ES.indexOf(e)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Ei.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;let t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return dt(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$ES)===null||e===void 0||e.forEach(t=>{var r;return(r=t.hostConnected)===null||r===void 0?void 0:r.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$ES)===null||e===void 0||e.forEach(t=>{var r;return(r=t.hostDisconnected)===null||r===void 0?void 0:r.call(t)})}attributeChangedCallback(e,t,r){this._$AK(e,r)}_$EO(e,t,r=ft){var n;let i=this.constructor._$Ep(e,r);if(i!==void 0&&r.reflect===!0){let s=(((n=r.converter)===null||n===void 0?void 0:n.toAttribute)!==void 0?r.converter:mt).toAttribute(t,r.type);this._$El=e,s==null?this.removeAttribute(i):this.setAttribute(i,s),this._$El=null}}_$AK(e,t){var r;let n=this.constructor,i=n._$Ev.get(e);if(i!==void 0&&this._$El!==i){let s=n.getPropertyOptions(i),c=typeof s.converter=="function"?{fromAttribute:s.converter}:((r=s.converter)===null||r===void 0?void 0:r.fromAttribute)!==void 0?s.converter:mt;this._$El=i,this[i]=c.fromAttribute(t,s.type),this._$El=null}}requestUpdate(e,t,r){let n=!0;e!==void 0&&(((r=r||this.constructor.getPropertyOptions(e)).hasChanged||_r)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),r.reflect===!0&&this._$El!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,r))):n=!1),!this.isUpdatePending&&n&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((n,i)=>this[i]=n),this._$Ei=void 0);let t=!1,r=this._$AL;try{t=this.shouldUpdate(r),t?(this.willUpdate(r),(e=this._$ES)===null||e===void 0||e.forEach(n=>{var i;return(i=n.hostUpdate)===null||i===void 0?void 0:i.call(n)}),this.update(r)):this._$Ek()}catch(n){throw t=!1,this._$Ek(),n}t&&this._$AE(r)}willUpdate(e){}_$AE(e){var t;(t=this._$ES)===null||t===void 0||t.forEach(r=>{var n;return(n=r.hostUpdated)===null||n===void 0?void 0:n.call(r)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,r)=>this._$EO(r,this[r],t)),this._$EC=void 0),this._$Ek()}updated(e){}firstUpdated(e){}};Z[gt]=!0,Z.elementProperties=new Map,Z.elementStyles=[],Z.shadowRootOptions={mode:"open"},xr?.({ReactiveElement:Z}),((ht=Ie.reactiveElementVersions)!==null&&ht!==void 0?ht:Ie.reactiveElementVersions=[]).push("1.6.3")});function Nr(o,e){if(!Array.isArray(o)||!o.hasOwnProperty("raw"))throw Error("invalid template strings array");return wr!==void 0?wr.createHTML(e):e}function pe(o,e,t=o,r){var n,i,s,c;if(e===G)return e;let a=r!==void 0?(n=t._$Co)===null||n===void 0?void 0:n[r]:t._$Cl,l=be(e)?void 0:e._$litDirective$;return a?.constructor!==l&&((i=a?._$AO)===null||i===void 0||i.call(a,!1),l===void 0?a=void 0:(a=new l(o),a._$AT(o,t,r)),r!==void 0?((s=(c=t)._$Co)!==null&&s!==void 0?s:c._$Co=[])[r]=a:t._$Cl=a),a!==void 0&&(e=pe(o,a._$AS(o,e.values),a,r)),e}var vt,He,de,wr,bt,q,Mr,Nn,ie,ye,be,Tr,Rn,yt,ve,$r,Er,oe,Sr,Ar,kr,Or,E,j,G,C,Pr,ne,Bn,xe,xt,_e,he,_t,jn,wt,$t,Et,Cr,Rr,we=w(()=>{d();p();h();He=window,de=He.trustedTypes,wr=de?de.createPolicy("lit-html",{createHTML:o=>o}):void 0,bt="$lit$",q=`lit$${(Math.random()+"").slice(9)}$`,Mr="?"+q,Nn=`<${Mr}>`,ie=document,ye=()=>ie.createComment(""),be=o=>o===null||typeof o!="object"&&typeof o!="function",Tr=Array.isArray,Rn=o=>Tr(o)||typeof o?.[Symbol.iterator]=="function",yt=`[ 	
\f\r]`,ve=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,$r=/-->/g,Er=/>/g,oe=RegExp(`>|${yt}(?:([^\\s"'>=/]+)(${yt}*=${yt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Sr=/'/g,Ar=/"/g,kr=/^(?:script|style|textarea|title)$/i,Or=o=>(e,...t)=>({_$litType$:o,strings:e,values:t}),E=Or(1),j=Or(2),G=Symbol.for("lit-noChange"),C=Symbol.for("lit-nothing"),Pr=new WeakMap,ne=ie.createTreeWalker(ie,129,null,!1);Bn=(o,e)=>{let t=o.length-1,r=[],n,i=e===2?"<svg>":"",s=ve;for(let c=0;c<t;c++){let a=o[c],l,u,m=-1,x=0;for(;x<a.length&&(s.lastIndex=x,u=s.exec(a),u!==null);)x=s.lastIndex,s===ve?u[1]==="!--"?s=$r:u[1]!==void 0?s=Er:u[2]!==void 0?(kr.test(u[2])&&(n=RegExp("</"+u[2],"g")),s=oe):u[3]!==void 0&&(s=oe):s===oe?u[0]===">"?(s=n??ve,m=-1):u[1]===void 0?m=-2:(m=s.lastIndex-u[2].length,l=u[1],s=u[3]===void 0?oe:u[3]==='"'?Ar:Sr):s===Ar||s===Sr?s=oe:s===$r||s===Er?s=ve:(s=oe,n=void 0);let _=s===oe&&o[c+1].startsWith("/>")?" ":"";i+=s===ve?a+Nn:m>=0?(r.push(l),a.slice(0,m)+bt+a.slice(m)+q+_):a+q+(m===-2?(r.push(void 0),c):_)}return[Nr(o,i+(o[t]||"<?>")+(e===2?"</svg>":"")),r]},xe=class o{constructor({strings:e,_$litType$:t},r){let n;this.parts=[];let i=0,s=0,c=e.length-1,a=this.parts,[l,u]=Bn(e,t);if(this.el=o.createElement(l,r),ne.currentNode=this.el.content,t===2){let m=this.el.content,x=m.firstChild;x.remove(),m.append(...x.childNodes)}for(;(n=ne.nextNode())!==null&&a.length<c;){if(n.nodeType===1){if(n.hasAttributes()){let m=[];for(let x of n.getAttributeNames())if(x.endsWith(bt)||x.startsWith(q)){let _=u[s++];if(m.push(x),_!==void 0){let b=n.getAttribute(_.toLowerCase()+bt).split(q),$=/([.?@])?(.*)/.exec(_);a.push({type:1,index:i,name:$[2],strings:b,ctor:$[1]==="."?_t:$[1]==="?"?wt:$[1]==="@"?$t:he})}else a.push({type:6,index:i})}for(let x of m)n.removeAttribute(x)}if(kr.test(n.tagName)){let m=n.textContent.split(q),x=m.length-1;if(x>0){n.textContent=de?de.emptyScript:"";for(let _=0;_<x;_++)n.append(m[_],ye()),ne.nextNode(),a.push({type:2,index:++i});n.append(m[x],ye())}}}else if(n.nodeType===8)if(n.data===Mr)a.push({type:2,index:i});else{let m=-1;for(;(m=n.data.indexOf(q,m+1))!==-1;)a.push({type:7,index:i}),m+=q.length-1}i++}}static createElement(e,t){let r=ie.createElement("template");return r.innerHTML=e,r}};xt=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;let{el:{content:r},parts:n}=this._$AD,i=((t=e?.creationScope)!==null&&t!==void 0?t:ie).importNode(r,!0);ne.currentNode=i;let s=ne.nextNode(),c=0,a=0,l=n[0];for(;l!==void 0;){if(c===l.index){let u;l.type===2?u=new _e(s,s.nextSibling,this,e):l.type===1?u=new l.ctor(s,l.name,l.strings,this,e):l.type===6&&(u=new Et(s,this,e)),this._$AV.push(u),l=n[++a]}c!==l?.index&&(s=ne.nextNode(),c++)}return ne.currentNode=ie,i}v(e){let t=0;for(let r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(e,r,t),t+=r.strings.length-2):r._$AI(e[t])),t++}},_e=class o{constructor(e,t,r,n){var i;this.type=2,this._$AH=C,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=r,this.options=n,this._$Cp=(i=n?.isConnected)===null||i===void 0||i}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=pe(this,e,t),be(e)?e===C||e==null||e===""?(this._$AH!==C&&this._$AR(),this._$AH=C):e!==this._$AH&&e!==G&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):Rn(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==C&&be(this._$AH)?this._$AA.nextSibling.data=e:this.$(ie.createTextNode(e)),this._$AH=e}g(e){var t;let{values:r,_$litType$:n}=e,i=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=xe.createElement(Nr(n.h,n.h[0]),this.options)),n);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===i)this._$AH.v(r);else{let s=new xt(i,this),c=s.u(this.options);s.v(r),this.$(c),this._$AH=s}}_$AC(e){let t=Pr.get(e.strings);return t===void 0&&Pr.set(e.strings,t=new xe(e)),t}T(e){Tr(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,r,n=0;for(let i of e)n===t.length?t.push(r=new o(this.k(ye()),this.k(ye()),this,this.options)):r=t[n],r._$AI(i),n++;n<t.length&&(this._$AR(r&&r._$AB.nextSibling,n),t.length=n)}_$AR(e=this._$AA.nextSibling,t){var r;for((r=this._$AP)===null||r===void 0||r.call(this,!1,!0,t);e&&e!==this._$AB;){let n=e.nextSibling;e.remove(),e=n}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}},he=class{constructor(e,t,r,n,i){this.type=1,this._$AH=C,this._$AN=void 0,this.element=e,this.name=t,this._$AM=n,this.options=i,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=C}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,r,n){let i=this.strings,s=!1;if(i===void 0)e=pe(this,e,t,0),s=!be(e)||e!==this._$AH&&e!==G,s&&(this._$AH=e);else{let c=e,a,l;for(e=i[0],a=0;a<i.length-1;a++)l=pe(this,c[r+a],t,a),l===G&&(l=this._$AH[a]),s||(s=!be(l)||l!==this._$AH[a]),l===C?e=C:e!==C&&(e+=(l??"")+i[a+1]),this._$AH[a]=l}s&&!n&&this.j(e)}j(e){e===C?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},_t=class extends he{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===C?void 0:e}},jn=de?de.emptyScript:"",wt=class extends he{constructor(){super(...arguments),this.type=4}j(e){e&&e!==C?this.element.setAttribute(this.name,jn):this.element.removeAttribute(this.name)}},$t=class extends he{constructor(e,t,r,n,i){super(e,t,r,n,i),this.type=5}_$AI(e,t=this){var r;if((e=(r=pe(this,e,t,0))!==null&&r!==void 0?r:C)===G)return;let n=this._$AH,i=e===C&&n!==C||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,s=e!==C&&(n===C||i);i&&this.element.removeEventListener(this.name,this,n),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,r;typeof this._$AH=="function"?this._$AH.call((r=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&r!==void 0?r:this.element,e):this._$AH.handleEvent(e)}},Et=class{constructor(e,t,r){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(e){pe(this,e)}},Cr=He.litHtmlPolyfillSupport;Cr?.(xe,_e),((vt=He.litHtmlVersions)!==null&&vt!==void 0?vt:He.litHtmlVersions=[]).push("2.8.0");Rr=(o,e,t)=>{var r,n;let i=(r=t?.renderBefore)!==null&&r!==void 0?r:e,s=i._$litPart$;if(s===void 0){let c=(n=t?.renderBefore)!==null&&n!==void 0?n:null;i._$litPart$=s=new _e(e.insertBefore(ye(),c),c,void 0,t??{})}return s._$AI(o),s}});var St,At,z,Br,jr=w(()=>{d();p();h();Fe();Fe();we();we();z=class extends Z{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;let r=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=r.firstChild),r}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Rr(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return G}};z.finalized=!0,z._$litElement$=!0,(St=globalThis.litElementHydrateSupport)===null||St===void 0||St.call(globalThis,{LitElement:z});Br=globalThis.litElementPolyfillSupport;Br?.({LitElement:z});((At=globalThis.litElementVersions)!==null&&At!==void 0?At:globalThis.litElementVersions=[]).push("3.3.3")});var Lr=w(()=>{d();p();h();});var D=w(()=>{d();p();h();Fe();we();jr();Lr()});var Ir=w(()=>{d();p();h();});function M(o){return(e,t)=>t!==void 0?In(o,e,t):Ln(o,e)}var Ln,In,Pt=w(()=>{d();p();h();Ln=(o,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,o)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,o)}},In=(o,e,t)=>{e.constructor.createProperty(t,o)}});var Fr=w(()=>{d();p();h();Pt();});var se=w(()=>{d();p();h();});var Hr=w(()=>{d();p();h();se();});var Ur=w(()=>{d();p();h();se();});var zr=w(()=>{d();p();h();se();});var Dr=w(()=>{d();p();h();se();});var Ct,Su,Mt=w(()=>{d();p();h();se();Su=((Ct=window.HTMLSlotElement)===null||Ct===void 0?void 0:Ct.prototype.assignedElements)!=null?(o,e)=>o.assignedElements(e):(o,e)=>o.assignedNodes(e).filter(t=>t.nodeType===Node.ELEMENT_NODE)});var Vr=w(()=>{d();p();h();se();Mt();});var fe=w(()=>{d();p();h();Ir();Pt();Fr();Hr();Ur();zr();Dr();Mt();Vr()});var X,Yr,Ue=w(()=>{d();p();h();D();X=({title:o,children:e})=>E`
...
`});var Wr,Zr,ze,Gr=w(()=>{d();p();h();Wr={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Zr=o=>(...e)=>({_$litDirective$:o,values:e}),ze=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,r){this._$Ct=e,this._$AM=t,this._$Ci=r}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}});var Xr,Fn,ae,qr=w(()=>{d();p();h();we();Gr();Xr="important",Fn=" !"+Xr,ae=Zr(class extends ze{constructor(o){var e;if(super(o),o.type!==Wr.ATTRIBUTE||o.name!=="style"||((e=o.strings)===null||e===void 0?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(o){return Object.keys(o).reduce((e,t)=>{let r=o[t];return r==null?e:e+`${t=t.includes("-")?t:t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${r};`},"")}update(o,[e]){let{style:t}=o.element;if(this.ht===void 0){this.ht=new Set;for(let r in e)this.ht.add(r);return this.render(e)}this.ht.forEach(r=>{e[r]==null&&(this.ht.delete(r),r.includes("-")?t.removeProperty(r):t[r]="")});for(let r in e){let n=e[r];if(n!=null){this.ht.add(r);let i=typeof n=="string"&&n.endsWith(Fn);r.includes("-")||i?t.setProperty(r,i?n.slice(0,-11):n,i?Xr:""):t[r]=n}}return G}})});var De=w(()=>{d();p();h();qr()});function Kr(o){return{top:o.y,right:o.x+o.width,bottom:o.y+o.height,left:o.x}}function Qr(o,e){let t=Kr(o),r=Kr(e),n=!(t.top>r.bottom||t.bottom<r.top),i=!(t.left>r.right||t.right<r.left);if(i&&n){let u={x:(Math.max(t.left,r.left)+Math.min(t.right,r.right))/2,y:(Math.max(t.top,r.top)+Math.min(t.bottom,r.bottom))/2};return[{points:[{x:t.left,y:u.y},{x:r.left,y:u.y}]},{points:[{x:t.right,y:u.y},{x:r.right,y:u.y}]},{points:[{y:t.top,x:u.x},{y:r.top,x:u.x}]},{points:[{y:t.bottom,x:u.x},{y:r.bottom,x:u.x}]}]}let s=t.left>r.right,c=t.top>r.bottom,a={x:o.x+o.width/2,y:o.y+o.height/2};return[i?null:{points:[{x:s?t.left:t.right,y:a.y},{x:s?r.right:r.left,y:a.y}],bisector:n?void 0:[{x:s?r.right:r.left,y:a.y},{x:s?r.right:r.left,y:c?r.bottom:r.top}]},n?null:{points:[{y:c?t.top:t.bottom,x:a.x},{y:c?r.bottom:r.top,x:a.x}],bisector:i?void 0:[{y:c?r.bottom:r.top,x:a.x},{y:c?r.bottom:r.top,x:s?r.right:r.left}]}].filter(u=>!!u)}function Ee(o){return Math.round(o*100)/100}function Ve(o,e){return[...Jr(o),...Jr(e)]}function Jr(o){return o?o instanceof Array?o:[o]:[]}var Se=w(()=>{d();p();h()});var Hn,eo,to=w(()=>{d();p();h();fe();Hn=function(o,e,t,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(o,e,t,r);else for(var c=o.length-1;c>=0;c--)(s=o[c])&&(i=(n<3?s(i):n>3?s(e,t,i):s(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i},eo=o=>{class e extends o{constructor(...r){super(...r),this.selectedNode=null}updated(r){super.updated(r),r.has("selectedNode")&&this.dispatchEvent(new CustomEvent("nodeselect",{detail:{selectedNode:this.selectedNode}}))}}return Hn([M({attribute:!1})],e.prototype,"selectedNode",void 0),e}});function Ye(o){return o.touches.length===0||o.touches.length>2}function Un(o,e){return Math.sqrt(Math.pow(o.x-e.x,2)+Math.pow(o.y-e.y,2))}var ro,oo=w(()=>{d();p();h();ro=o=>class extends o{constructor(...t){super(...t),this.previousTouches=null,this.addEventListener("touchstart",r=>{Ye(r)||(r.preventDefault(),this.previousTouches=r.touches)}),this.addEventListener("touchend",r=>{Ye(r)||(r.preventDefault(),this.previousTouches=null)}),this.addEventListener("touchcancel",r=>{Ye(r)||(r.preventDefault(),this.previousTouches=null)}),this.addEventListener("touchmove",r=>{if(Ye(r))return;let n=Array.from(this.previousTouches||[]),i=Array.from(r.touches);if(this.previousTouches=r.touches,!(i.length!==n.length||!i.every(s=>n.some(c=>c.identifier===s.identifier)))){if(i.length===1){this.onTouchPan({x:i[0].pageX-n[0].pageX,y:i[0].pageY-n[0].pageY});return}this.onTouchPinch(Un({x:i[0].pageX,y:i[0].pageY},{x:n[0].pageX,y:n[0].pageY}))}})}get isTouching(){return!!(this.previousTouches&&this.previousTouches.length>0)}onTouchPan(t){}onTouchPinch(t){}}});var Ae,V,no,io,so=w(()=>{d();p();h();fe();oo();Ae=function(o,e,t,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(o,e,t,r);else for(var c=o.length-1;c>=0;c--)(s=o[c])&&(i=(n<3?s(i):n>3?s(e,t,i):s(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i},V=function(o,e,t,r){if(t==="a"&&!r)throw new TypeError("Private accessor was defined without a getter");if(typeof e=="function"?o!==e||!r:!e.has(o))throw new TypeError("Cannot read private member from an object whose class did not declare it");return t==="m"?r:t==="a"?r.call(o):r?r.value:e.get(o)},no=function(o,e,t,r,n){if(r==="m")throw new TypeError("Private method is not writable");if(r==="a"&&!n)throw new TypeError("Private accessor was defined without a setter");if(typeof e=="function"?o!==e||!n:!e.has(o))throw new TypeError("Cannot write private member to an object whose class did not declare it");return r==="a"?n.call(o,t):n?n.value=t:e.set(o,t),t},io=o=>{var e,t,r,n,i;class s extends ro(o){constructor(...a){super(...a),this.panX=0,this.panY=0,this.scale=1,this.zoomSpeed=500,this.panSpeed=500,e.set(this,!1),t.set(this,(u,m)=>{this.panX+=u/this.scale/window.devicePixelRatio,this.panY+=m/this.scale/window.devicePixelRatio}),r.set(this,u=>{u.code==="Space"&&!V(this,e,"f")&&(no(this,e,!0,"f"),document.body.style.cursor="grab")}),n.set(this,u=>{u.code==="Space"&&V(this,e,"f")&&(no(this,e,!1,"f"),document.body.style.cursor="auto")}),i.set(this,()=>{document.addEventListener("keyup",V(this,n,"f")),document.addEventListener("keydown",V(this,r,"f"))}),this.addEventListener("wheel",u=>{if(this.isMovable)if(u.preventDefault(),u.ctrlKey){let{deltaY:m}=u;u.deltaMode===1&&(m*=15);let x=this.scale;this.scale*=1-m/((1e3-this.zoomSpeed)*.5);let _=u.offsetX-this.offsetWidth/2,b=u.offsetY-this.offsetHeight/2;this.panX+=_/this.scale-_/x,this.panY+=b/this.scale-b/x}else{let m=this.panSpeed*.002;this.panX-=u.deltaX*m/this.scale,this.panY-=u.deltaY*m/this.scale}},{passive:!1});let l=1;this.addEventListener("gesturestart",u=>{u.preventDefault(),l=this.scale}),this.addEventListener("gesturechange",u=>{let m=u;m.preventDefault(),this.scale=l*m.scale}),this.addEventListener("pointermove",u=>{u.buttons&4&&(u.preventDefault(),V(this,t,"f").call(this,u.movementX,u.movementY))}),V(this,i,"f").call(this),this.onmousedown=()=>{V(this,e,"f")&&(document.body.style.cursor="grabbing",this.onmousemove=({movementX:u,movementY:m})=>{V(this,t,"f").call(this,u,m)},this.onmouseup=()=>{document.body.style.cursor="grab",this.onmousemove=null,this.onmouseup=null})}}get isMovable(){return!0}get canvasTransform(){return[`scale(${this.scale})`,`translate(${this.panX}px, ${this.panY}px)`]}disconnectedCallback(){document.removeEventListener("keyup",V(this,n,"f")),document.removeEventListener("keydown",V(this,r,"f")),super.disconnectedCallback()}updated(a){super.updated(a),a.has("scale")&&this.dispatchEvent(new CustomEvent("scalechange",{detail:{scale:this.scale}})),(a.has("panX")||a.has("panY"))&&this.dispatchEvent(new CustomEvent("positionchange",{detail:{x:this.panX,y:this.panY}}))}onTouchPan(a){this.panX+=a.x/this.scale,this.panY+=a.y/this.scale}onTouchPinch(a){this.scale*=1-a/1e3}}return e=new WeakMap,t=new WeakMap,r=new WeakMap,n=new WeakMap,i=new WeakMap,Ae([M({attribute:!1})],s.prototype,"panX",void 0),Ae([M({attribute:!1})],s.prototype,"panY",void 0),Ae([M({attribute:!1})],s.prototype,"scale",void 0),Ae([M({type:Number,attribute:"zoom-speed"})],s.prototype,"zoomSpeed",void 0),Ae([M({type:Number,attribute:"pan-speed"})],s.prototype,"panSpeed",void 0),s}});var zn,Dn,ao,lo,co,uo=w(()=>{d();p();h();D();De();Se();zn=({guide:o,reverseScale:e})=>{let t=Math.abs(o.points[0].x-o.points[1].x),r=Math.abs(o.points[0].y-o.points[1].y);return t===0&&r===0?null:j`
  ...
  `},ao=new Map,lo=({node:o,distanceTo:e,reverseScale:t,fontSize:r})=>{let n=o.id+`
`+e.id,i=ao.get(n);return i||(i=Qr(o.absoluteBoundingBox,e.absoluteBoundingBox),ao.set(n,i)),[...i.map(s=>zn({guide:s,reverseScale:t})),...i.map(s=>Dn({guide:s,reverseScale:t,fontSize:r}))]},co=B`
  .distance-line {
    shape-rendering: geometricPrecision;
    fill: none;
    opacity: 0;
...
`});var po,kt,ho,fo,mo,Ot=w(()=>{d();p();h();D();po=({onClick:o=()=>{}})=>j`
...
`)}},go=o=>[Math.trunc(255*o.r),Math.trunc(255*o.g),Math.trunc(255*o.b)],Wn=o=>{let[e,t,r]=go(o);return"#"+((1<<24)+(e<<16)+(t<<8)+r).toString(16).slice(1)},Rt=({property:o,value:e})=>`${o}: ${e};`});var Zn,Bt,yo,Gn,Xn,bo,xo=w(()=>{d();p();h();D();Ot();vo();Zn=function(o,e,t,r){function n(i){return i instanceof t?i:new t(function(s){s(i)})}return new(t||(t=Promise))(function(i,s){function c(u){try{l(r.next(u))}catch(m){s(m)}}function a(u){try{l(r.throw(u))}catch(m){s(m)}}function l(u){u.done?i(u.value):n(u.value).then(c,a)}l((r=r.apply(o,e||[])).next())})},Bt=o=>Zn(void 0,void 0,void 0,function*(){yield navigator.clipboard.writeText(o)}),yo=({node:o,onClose:e})=>{if(!o)return null;let t=new We(o),r=n=>n.stopPropagation();return E`
    ...
    >
      <div class="inspector-section selectable-content">
        ...
        <div class="properties-overview">
          ...
          ${t.fontPostScriptName?E`<p class="inspector-property">
                <span>Font:</span>
                ${t.fontPostScriptName}
              </p>`:null}
        </div>
      </div>
      ${t.hasPadding?E`<div class="inspector-section">
            <h4>Layout</h4>
            ${t.horizontalPadding&&E`<p class="inspector-property">
              ${ho()} ${t.horizontalPadding}
            </p>`}
            ${t.verticalPadding&&E`<p class="inspector-property">
              ${fo()} ${t.verticalPadding}
            </p>`}
          </div>`:null}
      ${o.characters?E`<div class="inspector-section">
            <div class="title-section">
              <h4>Content</h4>
  ...
  `},Gn=o=>{let e=()=>Bt(o.getStyleSheet()),t=o.getStyles();return E`<div class="inspector-section">
  ...
  </div>`},Xn=o=>{let{property:e,value:t,color:r}=o,n=null;switch(e){case"background":case"fill":case"border":case"box-shadow":case"color":n=E`<span
        class="color-preview"
        style="background-color: ${r}"
      ></span>`;break;case"background-image":n=E`<span
        class="color-preview"
        style="background-image: ${t}"
      ></span>`;break}return E`<div class="css-property" @click=${()=>Bt(Rt(o))}>
...
`});var jt,_o,wo,$o=w(()=>{d();p();h();D();De();Se();jt=({node:o,selected:e=!1,computedThickness:t,onClick:r})=>{let{x:n,y:i,width:s,height:c}=o.absoluteBoundingBox,a="cornerRadius"in o&&o.cornerRadius?{topLeft:o.cornerRadius,topRight:o.cornerRadius,bottomRight:o.cornerRadius,bottomLeft:o.cornerRadius}:"rectangleCornerRadii"in o&&o.rectangleCornerRadii?{topLeft:o.rectangleCornerRadii[0],topRight:o.rectangleCornerRadii[1],bottomRight:o.rectangleCornerRadii[2],bottomLeft:o.rectangleCornerRadii[3]}:{topLeft:0,topRight:0,bottomRight:0,bottomLeft:0},l=t/2,u=(b,$)=>`M${b},${$}`,m=(b,$)=>`L${b},${$}`,x=(b,$,A)=>`A${b},${b} 0 0 1 ${$},${A}`,_=[u(a.topLeft+l,l),m(s-a.topRight,l),x(a.topRight-l,s-l,a.topRight),m(s-l,c-a.bottomRight),x(a.bottomRight-l,s-a.bottomRight,c-l),m(a.bottomLeft,c-l),x(a.bottomLeft-l,l,c-a.bottomLeft),m(l,a.topLeft),x(a.topLeft-l,a.topLeft,l),"Z"].join(" ");return j`
    <path
      ...
      @click=${r}
    />
  `},_o=({nodeSize:{x:o,y:e,width:t,height:r},offsetX:n,offsetY:i,reverseScale:s})=>{let c={top:`${i+e+r}px`,left:`${n+o+t/2}px`,transform:`translateX(-50%) scale(${s}) translateY(0.25em)`};return E`
...
`,Co=o=>{if(!o||!o.link||o.link===void 0||o.link==="undefined")return null;let{link:e,timestamp:t,fileName:r}=o;return E`<a
    class="figma-footer"
    target="_blank"
    rel="noopener"
    title="Open in Figma"
  ...
  >
    ...
    >
      Edited ${So(t)}
        ...
        "
          >
            ${Object.entries(this.__images).map(([_,b])=>{var $;let A=H(this,i,"f").call(this,_);if(!A||!("absoluteBoundingBox"in A)||!(!(($=H(this,t,"f"))===null||$===void 0)&&$[A.id]))return null;let P=H(this,t,"f")[A.id];return E`
                <img
                  class="rendered-image"
                  src="${b}"
                  style=${ae({top:`${A.absoluteBoundingBox.y-a.y}px`,left:`${A.absoluteBoundingBox.x-a.x}px`,marginTop:`${-P.top}px`,marginLeft:`${-P.left}px`,width:A.absoluteBoundingBox.width+P.left+P.right+"px",height:A.absoluteBoundingBox.height+P.top+P.bottom+"px"})}
                />
              `})}
            ...
            >
              ${this.selectedNode&&jt({node:this.selectedNode,selected:!0,computedThickness:m*l})}

              ${H(this,r,"f").map(_=>{var b;return _.id===((b=this.selectedNode)===null||b===void 0?void 0:b.id)?null:j`
                  <g>
                    ${jt({node:_,computedThickness:m*l,onClick:H(this,n,"f").call(this,_)})}
...
`],[`
  ...
  bottom: 0;
  left: 0;
`])));Vo=function(o){var e=o.config,t=T({state:"loading"}),r=t[0],n=t[1],i=function(s){return si(void 0,void 0,void 0,function(){var c,a,l,u,m,x,_,b,$,A,P,Q,Dt,Vt,ee;return ai(this,function(te){switch(te.label){case 0:n({state:"loading"}),te.label=1;case 1:if(te.trys.push([1,6,,7]),c=e.url.match(st),!c)throw new Error(e.url+" is not a valid Figma URL.");if(a=c[3],l=new URL(e.url),u=l.searchParams.get("node-id"),m=li(e),!m)throw new Error("Personal Access Token is required.");return x={"X-FIGMA-TOKEN":m},_=new URL("https://api.figma.com/v1/files/".concat(a)),b=new URL("https://api.figma.com/v1/images/".concat(a)),b.searchParams.set("format","svg"),u?[3,4]:[4,fetch(_.href,{headers:x,signal:s}).then(function(Y){return Ke(Y)})];case 2:return $=te.sent(),A=Yo($.document),b.searchParams.set("ids",A.map(function(Y){return Y.id}).join(",")),[4,fetch(b.href,{headers:x,signal:s}).then(function(Y){return Ke(Y)})];case 3:return P=te.sent(),n({state:"fetched",value:{type:"file",props:{documentNode:$,renderedImages:P.images,link:e.url}}}),[2];case 4:return _.pathname+="/nodes",_.searchParams.set("ids",u),b.searchParams.set("ids",u),[4,Promise.all([fetch(_.href,{headers:x,signal:s}).then(function(Y){return Ke(Y)}),fetch(b.href,{headers:x,signal:s}).then(function(Y){return Ke(Y)})])];case 5:return Q=te.sent(),Dt=Q[0],Vt=Q[1],n({state:"fetched",value:{type:"frame",props:{nodes:Dt,renderedImage:Object.values(Vt.images)[0],link:e.url}}}),[3,7];case 6:return ee=te.sent(),ee instanceof DOMException&&ee.code===DOMException.ABORT_ERR?[2]:(console.error(ee),n({state:"failed",error:ee instanceof Error?ee.message:String(ee)}),[3,7]);case 7:return[2]}})})};switch(N(function(){var s=!1,c=function(){s=!0},a=new AbortController;return i(a.signal).then(c,c),function(){s||a.abort()}},[e.url]),r.state){case"loading":return f(I,null,f(S,null,"Loading Figma file..."));case"failed":return f(I,null,f(S,null,"Failed to load Figma file"),f(S,null,r.error));case"fetched":return r.value.type==="file"?f(Ho,Je({css:zo},r.value.props)):f(Fo,Je({css:zo},r.value.props))}},ci=Vo});d();p();h();d();p();h();d();p();h();d();p();h();var yi=__STORYBOOKAPI__,{ActiveTabs:bi,Consumer:xi,ManagerContext:_i,Provider:wi,addons:Ce,combineParameters:$i,controlOrMetaKey:Ei,controlOrMetaSymbol:Si,eventMatchesShortcut:Ai,eventToShortcut:Pi,isMacLike:Ci,isShortcutTaken:Mi,keyToSymbol:Ti,merge:ki,mockChannel:Oi,optionOrAltSymbol:Ni,shortcutMatchesShortcut:Ri,shortcutToHumanString:Bi,types:Qe,useAddonState:ji,useArgTypes:Li,useArgs:Ii,useChannel:Fi,useGlobalTypes:Hi,useGlobals:Ui,useParameter:Me,useSharedState:zi,useStoryPrepared:Di,useStorybookApi:Vi,useStorybookState:Wt}=__STORYBOOKAPI__;U();L();d();p();h();var Oe="STORYBOOK_ADDON_DESIGNS",et=Oe+"/panel",ka={UpdateConfig:Oe+"/update_config"},le="design";d();p();h();R();U();L();var bn=function(){var o=function(e,t){return o=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(r,n){r.__proto__=n}||function(r,n){for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(r[i]=n[i])},o(e,t)};return function(e,t){if(typeof t!="function"&&t!==null)throw new TypeError("Class extends value "+String(t)+" is not a constructor or null");o(e,t);function r(){this.constructor=e}e.prototype=t===null?Object.create(t):(r.prototype=t.prototype,new r)}}(),nt=function(o){bn(e,o);function e(){var t=o!==null&&o.apply(this,arguments)||this;return t.state={hasError:!1},t}return e.getDerivedStateFromError=function(t){return{hasError:!0,error:t}},e.prototype.componentDidCatch=function(t,r){console.group("An error occurred during rendering Addon panel of storybook-addon-designs"),console.log("--- Error ---"),console.error(t),console.log("--- React Component Stack ---"),console.error(r.componentStack),console.groupEnd()},e.prototype.render=function(){return this.state.hasError?f(I,null,f(S,null,"Failed to render addon UI"),f(S,null,f("p",null,"Sorry, this addon has crashed due to the below error has thrown during rendering the addon UI."),f("pre",null,String(this.state.error)),f("p",null,"See console log for more details. To clear the error state, please reload the page."," ",f(re,{href:"https://github.com/pocka/storybook-addon-designs/issues/new?assignees=&labels=category%3A+bug&template=bug_report.yml",target:"_blank",rel:"noopener",withArrow:!0,cancel:!1},"Bug report")))):this.props.children},e}(tt);d();p();h();R();L();d();p();h();R();L();U();at();Re();d();p();h();R();L();U();d();p();h();R();L();d();p();h();R();var tr=function(o,e,t){if(t||arguments.length===2)for(var r=0,n=e.length,i;r<n;r++)(i||!(r in e))&&(i||(i=Array.prototype.slice.call(e,0,r)),i[r]=e[r]);return o.concat(i||Array.prototype.slice.call(e))},rr=function(o,e){var t=T([0,0]),r=t[0],n=t[1],i=T(!1),s=i[0],c=i[1],a=F(function(b){b.button===0&&(n([b.screenX,b.screenY]),c(!0))},[c,n]),l=F(function(b){var $=b.touches[0];n([$.screenX,$.screenY]),c(!0)},[c,n]),u=F(function(b){s&&n(function($){return o([b[0]-$[0],b[1]-$[1]]),b})},tr([n,s],e,!0)),m=F(function(b){var $=b.screenX,A=b.screenY;u([$,A])},[u]),x=F(function(b){var $=b.touches[0],A=$.screenX,P=$.screenY;u([A,P])},tr([n,s],e,!0)),_=F(function(){n([0,0]),c(!1)},[c,n]);return{onMouseDown:a,onMouseMove:m,onMouseUp:_,onMouseLeave:_,onTouchStart:l,onTouchMove:x,onTouchCancel:_,onTouchEnd:_}};var ir=function(o,e){return Object.defineProperty?Object.defineProperty(o,"raw",{value:e}):o.raw=e,o},lt=function(){return lt=Object.assign||function(o){for(var e,t=1,r=arguments.length;t<r;t++){e=arguments[t];for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&(o[n]=e[n])}return o},lt.apply(this,arguments)},sr=function(o){var e=o.children,t=o.className,r=o.style,n=o.defaultValue,i=o.value,s=o.onChange,c=T([0,0]),a=c[0],l=c[1];N(function(){l(n||i||[0,0])},[n]);var u=rr(function(x){s&&s(x),l(function(_){return[_[0]+x[0],_[1]+x[1]]})},[l,s]),m=W(function(){var x=i||a;return{transform:"translate(".concat(x[0],"px, ").concat(x[1],"px)")}},[i,a]);return f("div",lt({css:En,className:t,style:r},u),f("div",{css:Sn,style:m},e))};var En=O(or||(or=ir([`
  position: relative;
  overflow: hidden;
...
`],[`
  ...
  bottom: 0;
  left: 0;
`]))),or,nr;d();p();h();R();L();U();var ar=function(o){var e=o.onZoomIn,t=o.onZoomOut,r=o.onReset;return f(S,null,f(Te,{onClick:e},f(ke,{icon:"zoom"})),f(Te,{onClick:t},f(ke,{icon:"zoomout"})),f(Te,{onClick:r},f(ke,{icon:"zoomreset"})))};d();p();h();R();var lr=function(o,e){var t=T(1),r=t[0],n=t[1];N(function(){n(o)},e);var i=F(function(){n(function(a){return a+.1})},[n]),s=F(function(){n(function(a){return Math.max(a-.1,.1)})},[n]),c=F(function(){n(1)},[n]);return{scale:r,zoomIn:i,zoomOut:s,resetZoom:c}};var ct=function(o,e){return Object.defineProperty?Object.defineProperty(o,"raw",{value:e}):o.raw=e,o},pr=function(o){var e=o.config,t=lr(e.scale||1,[e.scale]),r=W(function(){return{transform:"scale(".concat(t.scale,")")}},[t.scale]);return f("div",{css:An},f(Gt,{border:!0},f(S,{key:"left"},f("p",null,f("b",null,"Image")),f(Xt,null),f(ar,{onReset:t.resetZoom,onZoomIn:t.zoomIn,onZoomOut:t.zoomOut}))),f(sr,{css:Pn,defaultValue:e.offset},f("img",{css:Cn,src:e.url,style:r})))};var An=O(cr||(cr=ct([`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
`],[`
  ...
  border-radius: 1px;
  box-shadow: 0px 0px 5px rgba(0, 0, 0, 0.15);
`]))),cr,ur,dr;d();p();h();L();U();var Mn=function(o,e){return Object.defineProperty?Object.defineProperty(o,"raw",{value:e}):o.raw=e,o},fr=function(o){var e,t,r,n=o.config;return f("div",{css:Tn},f(re,{cancel:!1,href:n.url,target:(e=n.target)!==null&&e!==void 0?e:"_blank",rel:(t=n.rel)!==null&&t!==void 0?t:"noopener",withArrow:(r=n.showArrow)!==null&&r!==void 0?r:!0},n.label||n.url))};var Tn=O(hr||(hr=Mn([`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
