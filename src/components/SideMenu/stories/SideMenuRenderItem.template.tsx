...
/** Возможно стоит убрать кастомизацию */
const renderCustomDivider = ({ dimension }: SideMenuDividerRenderProps) => <Divider $dimension={dimension} />;

const items: SideMenuProps['items'] = [
  { type: 'item', id: '1', label: 'Option1', labelType: 'header', render: renderCustomItem },
  { type: 'divider', render: renderCustomDivider },
