  ...
  return (
    <ThemeProvider theme={createBorderRadiusSwapper(themeBorderKind, CSSCustomProps)}>
      <T as="div" font="Body/Body 1 Long" style={{ marginBottom: '20px' }}>
        Пункты меню имеют ряд опций таких, как icon, badge и tag, позволяющих добавить в пункт соответствующие элементы.
        Также с помощью параметра labelType можно настроить начертание текста внутри пункта.
        <br />
        Такие элементы меню, как разделители (type="divider") могут опционально сопровождаться текстом.
        <br />
        Иконки и параметр labelType="header" применимы только к пунктам меню на первом уровне вложенности, на остальных
        уровнях вложенности данные параметры будут игнорироваться согласно требованиям дизайн-системы. Такое поведение
        пунктов меню можно кастомизировать с помощью функции render (подробнее в разделе "Кастомизация пунктов меню").
      </T>
      <Wrapper>
        <Header>
