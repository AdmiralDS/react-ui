  ...
  return (
    <ThemeProvider theme={createBorderRadiusSwapper(themeBorderKind, CSSCustomProps)}>
      <T as="div" font="Body/Body 1 Long" style={{ marginBottom: '20px' }}>
        ...
        <br />
        Иконки и параметр labelType применимы только к пунктам меню на первом уровне вложенности, на остальных уровнях
        вложенности данные параметры будут игнорироваться согласно требованиям дизайн-системы. Такое поведение пунктов
        меню можно кастомизировать с помощью функции render (подробнее в разделе "Кастомизация пунктов меню").
      </T>
      <Wrapper>
        <Header>
