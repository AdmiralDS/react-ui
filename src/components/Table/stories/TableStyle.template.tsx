  ...
  return (
    <>
      <T font="Body/Body 1 Long" as="div">
        ...
        <Separator />
        Также у элементов в таблице есть специальные <b>data-атрибуты</b>, которые описывают принадлежность элемента к
        определенным столбцу и строке. Ниже приведено подробное описание:
        <Table
        ...
        <UnorderedList dimension="s">
          ...
          <ListItem>
            ...
            параметр
            <code>showDividerForLastColumn</code> равен true;
          </ListItem>
          <ListItem>
