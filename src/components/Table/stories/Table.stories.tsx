...
export const StyleExample = {
  ...
  parameters: {
    ...
    </ul>\n\nТакже у ячеек в таблице 
      есть специальные <b>data-атрибуты</b>, которые описывают
      принадлежность ячейки к определенным столбцу и строке. Ниже приведено подробное описание:
      <table>
        <thead>
          <tr>
            <td width='250px'><b>Ячейка таблицы</b></td>
        ...
        <tbody>
          ...
          <tr>
            <td>Ячейка с чекбоксом в строке таблицы</td>
            <td>data-column='checkbox'</td>
            <td>data-row={id строки}</td>
          </tr>
          <tr>
            <td>Ячейка с иконкой стрелки (для раскрытия строки/группы строк) в строке таблицы</td>
