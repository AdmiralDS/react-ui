...
import { SegmentedControlv1, ALL_BORDER_RADIUS_VALUES } from '@admiral-ds/react-ui';
...
export default {
  title: 'Admiral-2.1/SegmentedControlv1',
  component: SegmentedControlv1,
  parameters: {
    docs: {
      source: {
        code: null,
...
} as Meta<typeof SegmentedControlv1>;

//<editor-fold desc="ButtonGroup. Playground">
const ButtonGroupPlaygroundStory: StoryFn<typeof SegmentedControlv1> = (props) => {
...
export const ButtonGroupPlayground = {
  ...
  name: 'SegmentedControlv1. Playground',
};
