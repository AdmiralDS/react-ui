...
import { DateInput, PanelWithOkButton } from '@admiral-ds/react-ui';
import type { BorderRadiusType, DateInputProps } from '@admiral-ds/react-ui';
import { createBorderRadiusSwapper } from '../../../../../.storybook/createBorderRadiusSwapper';

const renderPanelOk = () => {
  return <PanelWithOkButton />;
};

export const DateInputRangeWithButtonOkTemplate = ({
  placeholder,
  themeBorderKind,
  CSSCustomProps,
  ...props
  ...
  return (
    <ThemeProvider theme={createBorderRadiusSwapper(themeBorderKind, CSSCustomProps)}>
      <DateInput
        ...
        renderBottomPanel={renderPanelOk}
        type="date-range"
      />
    </ThemeProvider>
  );
