...
export const MinMaxExample = {
  ...
  parameters: {
    docs: {
      ...
      Если вручную введенное значение больше-меньше указанного диапазона, то автокоррекции значения при выводе фокуса из поля не происходит, 
      предполагается, что необходимая валидация и корректировка значения будет происходить на стороне пользователя. Также, если minValue >= 0, то
