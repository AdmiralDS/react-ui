...
export interface AccordionItemProps extends Omit<HTMLAttributes<HTMLDivElement>, 'onClick' | 'title'> {
  ...
  onClick?: (title: ReactNode, expanded: boolean, event: MouseEvent<HTMLDivElement>) => void;
