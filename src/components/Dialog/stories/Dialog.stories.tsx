...
import { DialogTwoButtonsTemplate } from './DialogTwoButtons.template';
...
import DialogTwoButtonsRaw from './DialogTwoButtons.template?raw';
...
const DialogTwoButtonsStory: StoryFn<typeof Dialog> = (props) => {
  const [{ CSSCustomProps }] = useGlobals();
  return <DialogTwoButtonsTemplate {...props} CSSCustomProps={CSSCustomProps} />;
};

export const DialogTwoButtonsExample = {
  render: DialogTwoButtonsStory,

  parameters: {
    docs: {
      source: {
        code: DialogTwoButtonsRaw,
      },
    },
  },

  name: 'Dialog. Пример c двумя кнопками.',
};
