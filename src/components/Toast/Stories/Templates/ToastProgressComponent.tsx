...
import type { ID, Theme, ToastItemProps, ToastProps, NotificationItemStatus } from '@admiral-ds/react-ui';
...
export const ToastProgressComponentTemplate = (props: ToastProps) => {
