...
import type { Options } from './TableRow';
...
export default {
  title: 'Admiral-2.1/Data Table/TableRefactor',
...
const Template: ComponentStory<typeof Table> = ({ columnList, ...args }) => {
  ...
  return (
    <Table {...args} columnList={cols} onColumnResize={handleResize} renderRow={renderRow} itemCount={rowList.length} />
  );
};
