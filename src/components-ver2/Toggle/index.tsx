...
import type { Dimension, LabelPosition } from '#src/components-ver2/Toggle/mixins';
import { sizes, SLIDER_SIZE_M, SLIDER_SIZE_S, sliderSizes, hoverSizes } from '#src/components-ver2/Toggle/mixins';
